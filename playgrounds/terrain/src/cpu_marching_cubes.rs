...
//! This module contains the original CPU implementation for reference and fallback
use crate::chunk::ChunkCoord;
use crate::marching_cubes::{get_cube_index, interpolate_vertex, TRIANGULATIONS};
use crate::terrain::{calculate_sdf_normal, create_terrain_sdf, TerrainConfig};
use bevy::prelude::*;
use bevy::render::mesh::PrimitiveTopology;
use bevy::render::render_asset::RenderAssetUsages;
use rayon::prelude::*;

/// Generate a terrain mesh for a specific chunk using CPU-based Marching Cubes
